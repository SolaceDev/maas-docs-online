...
htmlhelp_basename = 'SolaceCloudGettingStarteddoc'
...
latex_documents = [
    (master_doc, 'SolaceCloudGettingStarted.tex', u'Solace Cloud Getting Started Documentation',
     u'Tony Zoght', 'manual'),
]
...
man_pages = [
    (master_doc, 'solacecloudgettingstarted', u'Solace Cloud Getting Started Documentation',
     [author], 1)
]
